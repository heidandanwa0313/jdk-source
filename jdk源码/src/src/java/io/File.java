    ...
    implements Serializable, Comparable<File>
{
     ...
     */
    static private FileSystem fs = FileSystem.getFileSystem();      //DefaultFileSystem.getFileSystem()方法
     ...
     */
    public static final char separatorChar = fs.getSeparator();        //分隔符'/'
     ...
     */
    public static final String separator = "" + separatorChar;    //分隔符“/”
     ...
     * @see     java.lang.System#getProperty(java.lang.String)
     */
    public static final char pathSeparatorChar = fs.getPathSeparator();       //路径分隔符‘：’
     ...
     */
    public static final String pathSeparator = "" + pathSeparatorChar;      //路径分隔符“：”
...

	...
	this.path = fs.normalize(pathname);        //将文件名标准化
	...
	if (!uri.isAbsolute())   //判断该标识符是否是抽象的
	    throw new IllegalArgumentException("URI is not absolute");
	if (uri.isOpaque())    //an opaque uri has a scheme,a scheme-specific aprt,and possibly
...

     ...
     * @since 1.2
     */
    public boolean isHidden() {         //判断此抽象路径名表示的文件是否是一个抽象文件
	SecurityManager security = System.getSecurityManager();
	if (security != null) {
	    security.checkRead(path);
	}
